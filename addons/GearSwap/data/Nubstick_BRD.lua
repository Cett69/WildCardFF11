function get_sets()
    ...
    sets.precast.FC.Song = {main="Felibre's Dague",sub="Genbu's Shield",ammo=empty,
        head="Aoidos' Calot +2",neck="Orunmila's Torque",ear1={name="Loquac. Earring",priority=5},ear2="Enchanter Earring +1",
    ...
    DaurdSongs = T{"Puppet's Operetta",'Gold Capriccio','Warding Round','Herb Pastoral','Goblin Gavotte'}
